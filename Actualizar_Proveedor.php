...
<link rel="stylesheet" href="Actualizar_Proveedor.css" media="screen">
    ...
    <meta property="og:title" content="Actualizar_Proveedor">
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-valign-bottom-md u-valign-bottom-sm u-valign-bottom-xs u-container-layout-2">
                  <h1 class="u-align-center u-text u-text-default u-text-1">ACTUALIZAR PROVEEDOR</h1>
                  <div class="u-expanded-width-xs u-form u-form-1">
                    <?php
                      include("./conexion.php");
                      $resultMessageQuery = mysqli_query($conexion, "SELECT Nombre, Telefono, Direccion FROM proveedores WHERE ID_Proveedor=$id;");
                      $row = mysqli_fetch_array($resultMessageQuery)
                    ?>
                    <form action="actualizar_prov.php" class="" source="email" name="form" style="padding: 10px;" method="POST">
                      <div class="u-form-group u-form-name">
                        <label for="name-f2d6" class="u-label">Nombre</label>
                        <input type="text" placeholder="Ingresar Nombre del Porveedor" id="name-f2d6" name="nombre" class="u-input u-input-rectangle" required="" value="<?php echo $row[0] ?>">
                      </div>
                      <br>
                      <div class="u-form-email u-form-group">
                        <label for="email-f2d6" class="u-label">Direccion</label>
                        <input type="text" placeholder="Ingresar Direccion" id="email-f2d6" name="direccion" class="u-input u-input-rectangle" required="" value="<?php echo $row[2] ?>">
                      </div>
                      <br>
                      <div class="u-form-group u-form-group-3">
                        <label for="text-ddb4" class="u-label">Telefono</label>
                        <input type="text" placeholder="Ingresar Celular de Proveedor" id="text-ddb4" name="telefono" class="u-input u-input-rectangle" value="<?php echo $row[1] ?>">
                      </div>
                      <br>
