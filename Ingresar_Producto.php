...
<html style="font-size: 16px;" lang="es"><head>
    ...
    <title>Ingresar_Producto</title>
    <link rel="stylesheet" href="nicepage.css" media="screen">
<link rel="stylesheet" href="Ingresar_Producto.css" media="screen">
    ...
    <meta property="og:title" content="Ingresar_Producto">
            ...
            <div class="u-layout-row">
              ...
              <div class="u-align-left u-container-style u-layout-cell u-shape-rectangle u-size-30 u-layout-cell-2">
                <div class="u-container-layout u-valign-bottom-sm u-container-layout-2">
                  <h1 class="u-align-center u-text u-text-default-lg u-text-default-xl u-text-1">NUEVO PRODUCTO</h1>
                  <div class="u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
                    <form action="insertar_Producto.php" name="form" style="padding: 10px;" method="POST" enctype="multipart/form-data">

                      <div class="u-form-email u-form-group">
                        <label for="email-f2d6" class="u-label">Nombre</label>
                        <input type="text" placeholder="Introduce el Nombre del Producto" id="email-f2d6" class="u-input u-input-rectangle" name="nombreins" required="">
                      </div>
                      <br>
                      
                      <div class="u-form-group u-form-group-3">
                        <label for="text-ddb4" class="u-label">Tipo</label>
                        <input type="text" placeholder="Escribe el tipo que Conforma el Producto" id="text-ddb4" class="u-input u-input-rectangle" name="tipoins">
                      </div>
                      <br>
                      ...
                      <div class="u-form-group u-form-select u-form-group-4">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-a129" name="select" class="u-input u-input-rectangle">
                      ...
                      <div class="u-form-group u-form-group-5">
                        ...
                        <input type="number" placeholder="Agregar Precio " id="text-4e41" class="u-input u-input-rectangle" name="preicoins" required>
                      </div>
                      <br>
                      ...
                      <div class="u-form-group u-form-select u-form-group-4">
                        ...
                        <div class="u-form-select-wrapper">
                          <select id="select-a129" name="categorias" class="u-input u-input-rectangle">
                            <option value="marcas" data-calc="marcas" >--SELECCIONAR--</option>
                            <?php 
                                include ("./conexion.php");
                      ...
                      <div class="u-align-left u-form-group u-form-submit">
                        ...
                        <input type="submit" value="submit" class="u-form-control-hidden"  name="insertar">
                      </div>
